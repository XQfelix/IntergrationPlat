...
MAINCLASS=com.uinv.inter.intergration.IntergrationApplication
...
nohup java $JAVA_OPTS $JAVA_MEM_OPTS $JAVA_DEBUG_OPTS $JAVA_JMX_OPTS -Dlog4j.configuration=$LOG -classpath $CONF_DIR:$LIB_JARS $MAINCLASS> /dev/null 2>&1 &

#java $JAVA_OPTS $JAVA_MEM_OPTS $JAVA_DEBUG_OPTS $JAVA_JMX_OPTS -Dlog4j.configuration=$LOG -classpath $CONF_DIR:$LIB_JARS $MAINCLASS
