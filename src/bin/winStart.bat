...
color 0A
title Interface-plat-Process,Please do not close Window
...
set MAIN_CLASS=com.uinv.inter.intergration.IntergrationApplication
...
:: start
java -Dfile.encoding=UTF-8 -Xms256M -Xmx1024M -XX:PermSize=256M -XX:MaxPermSize=512M -classpath .\conf;%LIB_JARS% -client %MAIN_CLASS%
exit. & pause
